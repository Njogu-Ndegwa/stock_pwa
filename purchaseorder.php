            ...
            ?>
              <tr>
                ...
                <td>
                  ...
                  <div class="dropdown"><button class=" dropbtn action-delete-btn">More</button>
                    <div class="dropdown-content"><a href="#" onclick="openModal('#deletePurchaseOrder<?php echo $singlePurchaseOrderInfo['purchase_order_id']; ?>')">Delete</a>
                      <form method="post" action="<?php echo $_ENV['APP_URL'] ?>/app/formhandlers/purchaseorder/addPurchaseOrde"><input type="submit" name="Export as pdf" /></form>
                    </div>
                  </div>
                </td>
              </tr>
