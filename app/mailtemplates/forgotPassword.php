...
function forgotPasswordTemplate(String $username, int $code, String $appURL, String $token): String
{
  return "
       ...
       <div>
         <p style='padding:10px;font-size:1.17em;color:black;'>
           ...
           A forgot password request for your account has been received. Click on the button below to go to the password reset page<br/>
         </p>

         <a style='margin: 10px auto;display: flex;flex-direction:column;justify-content: center;text-decoration: none;text-align:center;' href=". $appURL ."/resetpassword/". $token .">
