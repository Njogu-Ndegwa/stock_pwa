...
function superAdminTemplate(String $username, int $code, String $appURL, String $token)
{
  return "
       ...
       <div>
         ...
         <a style='margin: 10px auto;display: flex;flex-direction:column;justify-content: center;text-decoration: none;text-align:center;' href=". $appURL ."/logintoken/". $token .">
