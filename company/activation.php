...
$tokenValidityResponse = $SuperUser->checkCompanyTokenValidity($token);
...
<body>
  <div class="form-container">
    ...
    <form class="" action="<?php echo $_ENV['APP_URL']; ?>/app/formhandlers/activateCompany" method="post">
      <?php
      ...
      <div class="input-wrapper">
        <input type="text" name="activation_key" placeholder="Enter code*" value="">
      </div>
